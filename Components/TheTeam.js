...
const TheTeam = () => {
    return ( 
        <div id="team" data-aos="fade-up" className="neondiv text-white lg:rounded-lg lg:mb-5 pt-8 pr-2 bg-Containers-0 pb-8 xl:ml-52 xl:mr-52 xlmin:ml-0 xlmin:mr-0 border-t-2 border-t-Containers-10 border-b-2 border-b-Containers-10">
                ...
                <div className="lg:flex mt-10 w-full justify-evenly">
                    <div className="flex flex-col justify-center items-center text-2xl hover:translate-y-2 duration-300">
                        ...
                        <div className="bg-TeamCircle-1 rounded-full w-64 h-64 flex justify-center items-center p-12">
                            <a target="_blank" href="https://twitter.com/FalseCrackzz" rel="noopener noreferrer">
                                <Image alt="" src={nft1}/>
                            </a>
                        </div>
                    ...
                    <div className="flex flex-col justify-center items-center text-2xl hover:translate-y-2 duration-300">
                        <h1 className="mb-3">Community Manager</h1>
                        <div className="bg-TeamCircle-2 rounded-full w-64 h-64 flex justify-center items-center p-12">
                            <a target="_blank" href="https://twitter.com/Bai_licious" rel="noopener noreferrer">
                                <Image alt="" src={nft2}/>
                            </a>
                        </div>
                        <p className="mt-3"><a>Bai</a></p>
                    </div>
                    <div className="flex flex-col justify-center items-center text-2xl hover:translate-y-2 duration-300">
                        <h1 className="mb-3">Community Manager</h1>
                        <div className="bg-TeamCircle-3 rounded-full w-64 h-64 flex justify-center items-center p-12">
                            <a target="_blank" href="https://twitter.com/0x_Wu" rel="noopener noreferrer">
                                <Image alt="" src={nft3}/>
                            </a>
                        </div>
                        <p className="mt-3"><a>Wu</a></p>
                    </div>
                </div>
