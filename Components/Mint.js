...
const Mint = () => {
    return ( 
        <div className="text-white rounded-lg pt-8 pr-2 bg-black pb-8 xl:ml-52 xl:mr-52 xlmin:ml-0 xlmin:mr-0 border-t-2 border-t-slate-50 border-b-2 border-b-slate-50">
            ...
            <div className="ni:flex">
                ...
                <div className="w-1/2 m-5 p-5 border-4 border-amber-400 rounded-lg">
                    ...
                    <div>
                        ...
                        <div className="flex justify-between border-t-2 border-b-2 border-white my-5 py-2 text-2xl">
                            <h1>TOTAL</h1>
                            <h1>0.00 ETH</h1>
                        </div>
                        <div>
