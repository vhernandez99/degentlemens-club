      ...
      <div className="grid lg:grid-cols-2 gap-5 lg:p-10 in:px-3">
        ...
        >
          ...
          <div className="flex flex-col justify-center items-start h-auto px-8 py-4  tracking-wide text-xl duration-300 group-hover:bg-Primarycolors-10 group-hover:text-Containers-10">
            ...
            <p>
              -All NFTs won in giveaways pre-mint will be sent directly to their
              wallets on mint day!
            </p>
            ...
            <p>
              {" "}
              -VIP section will open to HOLDERS ONLY. Filled with Holders-only
              benefits.{" "}
            </p>
            ...
            <p>
              {" "}
              -Network and organize collabs with different projects that share
              the same vision as we do.
            </p>

            <p className="my-3 text-2xl"> ● Fund Community Wallet. </p>
            <p>
              {" "}
              -15% of overall mint will be sent directly to Community wallet.{" "}
            </p>
            <p>
              {" "}
        ...
        >
          ...
          <div className="flex flex-col justify-center items-start h-auto px-8 py-4  tracking-wide text-xl duration-300 group-hover:bg-Primarycolors-10 group-hover:text-Containers-10">
            ...
            <p>
              - Upon opening, 50 OG members and 50 VIP members will be able to
              claim Merch of their choice for FREE.
            </p>
            <p>
              - Merch store will also be open to all holders at a discount while
              also receiving weekly giveaways of merch.{" "}
            </p>
            <p>
              - NON holders will be able to buy merch at full price and also win
              them in public giveaways.{" "}
            </p>
            ...
            <p className="my-3 text-2xl">
              {" "}
              ● Monthly meetings in VIP section to vote on certain steps to take
              as a community.{" "}
            </p>
            <p>
              {" "}
              - Holders will vote on all decisions we make as a project and what
        ...
        >
          ...
          <div className="flex flex-col justify-start items-start h-full px-8 py-4  tracking-wide text-xl duration-300 group-hover:bg-Primarycolors-10 group-hover:text-Containers-10">
            ...
            <p>
              - HOLDERS will be voting and choosing traits that are going to be
              used in the second collection, letting VIP members have their
              ideas be a part of the project.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col justify-start items-start h-full px-8 py-4  tracking-wide text-xl duration-300 group-hover:bg-Primarycolors-10 group-hover:text-Containers-10">
            ...
            <p>
              - Launch second collection where all holders will be able to mint
              for FREE. Any unclaimed will be for public mint at a price Tbd.
            </p>
            ...
            <p>
              - Dengentlemens Club will be purchasing land in the metaverse soon
              after sellout to reserve for building and developing our virtual
              Club/Casino in the Metaverse!{" "}
            </p>
          </div>
        </div>
      </div>
