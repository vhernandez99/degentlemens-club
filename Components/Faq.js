...
const Faq = () => {
    return ( 
        <div className="text-white lg:rounded-lg pt-8 pr-2 bg-Containers-0 mb-5 pb-8 xl:ml-52 xl:mr-52 xlmin:ml-0 xlmin:mr-0 border-t-2 border-t-Containers-10 border-b-2 border-b-Containers-10">
