            ...
            <div className="flex in:flex-col in:items-center lg:mx-10">
                ...
                <div className="flex flex-col items-start lg:w-1/2 px-10">
                    <div className="lg:text-6xl in:text-2xl in:mt-5 mb-10">
                        <h1 className="neontextyellow">Welcome to Degentlemens's Club NFT</h1>
                    </div>
                    ...
                    <div className="w-full">
                        <div className="w-full">
                        <a className="flex justify-between items-center bg-Primarycolors-10 text-Containers-0 hover:bg-Primarycolors-0 p-4 w-full text-xl">
                            Join the Pride on Discord
                            <FontAwesomeIcon className='w-8 h-8' icon={faDiscord}/>
                        </a>
                        </div>
                    </div>
                </div>
            ...
            <div className="lg:flex flex-row-reverse lg:mx-10 mt-10">
                ...
                <div className="flex flex-col items-start lg:w-1/2 px-10">
                    ...
                    <div className="w-full">
                        ...
                        <a className="flex justify-between items-center bg-Primarycolors-10 text-Containers-0 hover:bg-Primarycolors-0 p-4 w-full text-xl">
                            Purchase on OpenSea
                            <FontAwesomeIcon className='w-8 h-8' icon={faShip}/>
                        </a>
                        </div>
                    </div>
                </div>
